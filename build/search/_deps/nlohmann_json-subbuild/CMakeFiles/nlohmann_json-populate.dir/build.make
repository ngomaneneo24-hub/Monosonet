...
CMAKE_SOURCE_DIR = /workspace/build/search/_deps/nlohmann_json-subbuild

# The top-level build directory on which CMake was run.
CMAKE_BINARY_DIR = /workspace/build/search/_deps/nlohmann_json-subbuild
...
CMakeFiles/nlohmann_json-populate-complete: nlohmann_json-populate-prefix/src/nlohmann_json-populate-stamp/nlohmann_json-populate-test
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/workspace/build/search/_deps/nlohmann_json-subbuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Completed 'nlohmann_json-populate'"
	/usr/bin/cmake -E make_directory /workspace/build/search/_deps/nlohmann_json-subbuild/CMakeFiles
	/usr/bin/cmake -E touch /workspace/build/search/_deps/nlohmann_json-subbuild/CMakeFiles/nlohmann_json-populate-complete
	/usr/bin/cmake -E touch /workspace/build/search/_deps/nlohmann_json-subbuild/nlohmann_json-populate-prefix/src/nlohmann_json-populate-stamp/nlohmann_json-populate-done
...
nlohmann_json-populate-prefix/src/nlohmann_json-populate-stamp/nlohmann_json-populate-build: nlohmann_json-populate-prefix/src/nlohmann_json-populate-stamp/nlohmann_json-populate-configure
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/workspace/build/search/_deps/nlohmann_json-subbuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "No build step for 'nlohmann_json-populate'"
	cd /workspace/build/search/_deps/nlohmann_json-build && /usr/bin/cmake -E echo_append
	cd /workspace/build/search/_deps/nlohmann_json-build && /usr/bin/cmake -E touch /workspace/build/search/_deps/nlohmann_json-subbuild/nlohmann_json-populate-prefix/src/nlohmann_json-populate-stamp/nlohmann_json-populate-build
...
nlohmann_json-populate-prefix/src/nlohmann_json-populate-stamp/nlohmann_json-populate-configure: nlohmann_json-populate-prefix/src/nlohmann_json-populate-stamp/nlohmann_json-populate-patch
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/workspace/build/search/_deps/nlohmann_json-subbuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_3) "No configure step for 'nlohmann_json-populate'"
	cd /workspace/build/search/_deps/nlohmann_json-build && /usr/bin/cmake -E echo_append
	cd /workspace/build/search/_deps/nlohmann_json-build && /usr/bin/cmake -E touch /workspace/build/search/_deps/nlohmann_json-subbuild/nlohmann_json-populate-prefix/src/nlohmann_json-populate-stamp/nlohmann_json-populate-configure
...
nlohmann_json-populate-prefix/src/nlohmann_json-populate-stamp/nlohmann_json-populate-download: nlohmann_json-populate-prefix/src/nlohmann_json-populate-stamp/nlohmann_json-populate-mkdir
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/workspace/build/search/_deps/nlohmann_json-subbuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_4) "Performing download step (git clone) for 'nlohmann_json-populate'"
	cd /workspace/build/search/_deps && /usr/bin/cmake -DCMAKE_MESSAGE_LOG_LEVEL=VERBOSE -P /workspace/build/search/_deps/nlohmann_json-subbuild/nlohmann_json-populate-prefix/tmp/nlohmann_json-populate-gitclone.cmake
	cd /workspace/build/search/_deps && /usr/bin/cmake -E touch /workspace/build/search/_deps/nlohmann_json-subbuild/nlohmann_json-populate-prefix/src/nlohmann_json-populate-stamp/nlohmann_json-populate-download
...
nlohmann_json-populate-prefix/src/nlohmann_json-populate-stamp/nlohmann_json-populate-install: nlohmann_json-populate-prefix/src/nlohmann_json-populate-stamp/nlohmann_json-populate-build
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/workspace/build/search/_deps/nlohmann_json-subbuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_5) "No install step for 'nlohmann_json-populate'"
	cd /workspace/build/search/_deps/nlohmann_json-build && /usr/bin/cmake -E echo_append
	cd /workspace/build/search/_deps/nlohmann_json-build && /usr/bin/cmake -E touch /workspace/build/search/_deps/nlohmann_json-subbuild/nlohmann_json-populate-prefix/src/nlohmann_json-populate-stamp/nlohmann_json-populate-install

nlohmann_json-populate-prefix/src/nlohmann_json-populate-stamp/nlohmann_json-populate-mkdir:
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/workspace/build/search/_deps/nlohmann_json-subbuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_6) "Creating directories for 'nlohmann_json-populate'"
	/usr/bin/cmake -Dcfgdir= -P /workspace/build/search/_deps/nlohmann_json-subbuild/nlohmann_json-populate-prefix/tmp/nlohmann_json-populate-mkdirs.cmake
	/usr/bin/cmake -E touch /workspace/build/search/_deps/nlohmann_json-subbuild/nlohmann_json-populate-prefix/src/nlohmann_json-populate-stamp/nlohmann_json-populate-mkdir
...
nlohmann_json-populate-prefix/src/nlohmann_json-populate-stamp/nlohmann_json-populate-patch: nlohmann_json-populate-prefix/src/nlohmann_json-populate-stamp/nlohmann_json-populate-update
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/workspace/build/search/_deps/nlohmann_json-subbuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_7) "No patch step for 'nlohmann_json-populate'"
	/usr/bin/cmake -E echo_append
	/usr/bin/cmake -E touch /workspace/build/search/_deps/nlohmann_json-subbuild/nlohmann_json-populate-prefix/src/nlohmann_json-populate-stamp/nlohmann_json-populate-patch
...
nlohmann_json-populate-prefix/src/nlohmann_json-populate-stamp/nlohmann_json-populate-test: nlohmann_json-populate-prefix/src/nlohmann_json-populate-stamp/nlohmann_json-populate-install
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/workspace/build/search/_deps/nlohmann_json-subbuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_8) "No test step for 'nlohmann_json-populate'"
	cd /workspace/build/search/_deps/nlohmann_json-build && /usr/bin/cmake -E echo_append
	cd /workspace/build/search/_deps/nlohmann_json-build && /usr/bin/cmake -E touch /workspace/build/search/_deps/nlohmann_json-subbuild/nlohmann_json-populate-prefix/src/nlohmann_json-populate-stamp/nlohmann_json-populate-test
...
nlohmann_json-populate-prefix/src/nlohmann_json-populate-stamp/nlohmann_json-populate-update: nlohmann_json-populate-prefix/src/nlohmann_json-populate-stamp/nlohmann_json-populate-download
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/workspace/build/search/_deps/nlohmann_json-subbuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_9) "Performing update step for 'nlohmann_json-populate'"
	cd /workspace/build/search/_deps/nlohmann_json-src && /usr/bin/cmake -Dcan_fetch=YES -DCMAKE_MESSAGE_LOG_LEVEL=VERBOSE -P /workspace/build/search/_deps/nlohmann_json-subbuild/nlohmann_json-populate-prefix/tmp/nlohmann_json-populate-gitupdate.cmake
...
CMakeFiles/nlohmann_json-populate.dir/depend:
	cd /workspace/build/search/_deps/nlohmann_json-subbuild && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /workspace/build/search/_deps/nlohmann_json-subbuild /workspace/build/search/_deps/nlohmann_json-subbuild /workspace/build/search/_deps/nlohmann_json-subbuild /workspace/build/search/_deps/nlohmann_json-subbuild /workspace/build/search/_deps/nlohmann_json-subbuild/CMakeFiles/nlohmann_json-populate.dir/DependInfo.cmake "--color=$(COLOR)"
