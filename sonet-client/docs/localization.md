...
We want the official Sonet app to be supported in as many languages as possible. If you want to help us translate the app, please get involved on [Crowdin](https://sonet.crowdin.com/sonet-social) or open an issue on the [Sonet app repo on GitHub](https://github.com/sonet-social/social-app).

## Tools

- We use Crowdin to manage translations.
  - Sonet Crowdin: https://sonet.crowdin.com/sonet-social
...
[Crowdin](https://sonet.crowdin.com/sonet-social) is our primary tool for managing translations. There are two roles:
...
You can request a new language be added to the project by clicking **Request New Language** on [Crowdin](https://sonet.crowdin.com/sonet-social) or you can create a [GitHub issue](https://github.com/sonet-social/social-app/issues).
