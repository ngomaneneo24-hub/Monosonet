        ...
        {hasSession && (
          <>
            ...
            <Menu.Group>
              ...
              {/* Founder delete functionality - founders can delete any note */}
              {isFounder && !isAuthor && (
                <Menu.Item
                  testID="noteDropdownFounderDeleteBtn"
                  label={_(msg`Delete note (Moderation)`)}
                  onPress={onFounderDeleteNote}>
                  <Menu.ItemText>{_(msg`Delete note (Moderation)`)}</Menu.ItemText>
                  <Menu.ItemIcon icon={Trash} position="right" />
                </Menu.Item>
              )}
            </Menu.Group>
